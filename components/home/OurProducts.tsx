      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"14px" }}>
        ...
        <div style={{ display:"flex", gap:"5px" }}>
          {["Pipeline","Bookings","Clients"].map((t) => (
            <span key={t} style={{ fontSize:"9px", padding:"2px 7px", borderRadius:"4px", background: t==="Pipeline" ? "rgba(79,140,255,0.25)" : "rgba(255,255,255,0.06)", color: t==="Pipeline" ? "#7ab0ff" : "rgba(255,255,255,0.7)" }}>{t}</span>
          ))}
        </div>
      </div>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"14px" }}>
        ...
        <div style={{ display:"flex", gap:"5px" }}>
          {["Members","Payments","Trainers"].map((t) => (
            <span key={t} style={{ fontSize:"9px", padding:"2px 7px", borderRadius:"4px", background: t==="Members" ? "rgba(34,214,138,0.2)" : "rgba(255,255,255,0.06)", color: t==="Members" ? "#4eeaaa" : "rgba(255,255,255,0.7)" }}>{t}</span>
          ))}
        </div>
      </div>
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:"7px", marginBottom:"14px" }}>
        ...
        <div key={m.name} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"6px 0", borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display:"flex", alignItems:"center", gap:"8px" }}>
            ...
            <div>
              ...
              <div style={{ fontSize:"8px", color:"rgba(255,255,255,0.7)" }}>{m.days}</div>
            </div>
          </div>
