  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: isMobile ? "36px" : "56px", position: "relative" }}>
        ...
        >
          Purpose-built CRMs for industries that move fast.
        </p>
      </div>

      {/* Cards — stacked vertically, each card horizontal */}
      <div
        style={{
          display: "flex",
      ...
      >
        <ProductCard
          ...
          emoji="✈️"
          accentColor="#4f8cff"
          accentGlow="rgba(79,140,255,0.2)"
          name="Lidflow"
        ...
        <ProductCard
          ...
          emoji="🏋️"
          accentColor="#22d68a"
          accentGlow="rgba(34,214,138,0.2)"
          name="GrwFit"
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${hovered ? accentColor + "66" : "rgba(255,255,255,0.1)"}`,
        borderRadius: "22px",
        ...
        boxShadow: hovered ? `0 0 60px ${accentGlow}` : "none",
        cursor: "default",
      }}
    >
      {/* LEFT / RIGHT — Mockup */}
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "18px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: "11px", color: "rgba(255,255,255,0.4)", letterSpacing: "0.04em" }}>
              {target}
            </p>
          </div>
        </div>
        ...
        {/* Tagline */}
        <p style={{ margin: 0, fontSize: "15px", color: "rgba(255,255,255,0.75)", lineHeight: 1.55 }}>
          {tagline}
        </p>
        ...
        <a
          ...
          style={{
            ...
            color: accentColor === "#22d68a" ? "#051a0e" : "#fff",
            fontWeight: 700,
            fontSize: "13px",
            textDecoration: "none",
...
/* ─────────────────────────────────────────
   Lidflow Mockup — compact horizontal
───────────────────────────────────────── */
  ...
  return (
    <div style={{ padding: "16px 18px", fontFamily: "monospace" }}>
          ...
          {["Pipeline", "Bookings", "Clients"].map((t) => (
            <span
              ...
              style={{
                ...
                padding: "2px 7px",
                borderRadius: "4px",
                background: t === "Pipeline" ? "rgba(79,140,255,0.25)" : "rgba(255,255,255,0.06)",
                color: t === "Pipeline" ? "#7ab0ff" : "rgba(255,255,255,0.3)",
              }}
            >
              {t}
            </span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "7px", marginBottom: "14px" }}>
        {[
          { label: "New Leads", val: "48", color: "#6aaaff" },
          { label: "Bookings", val: "21", color: "#b89eff" },
          { label: "Revenue", val: "₹2.4L", color: "#4eeaaa" },
        ].map((s) => (
          <div
            key={s.label}
            style={{
      ...
      {/* Pipeline bars */}
      <div style={{ fontSize: "8px", color: "rgba(255,255,255,0.35)", marginBottom: "7px", letterSpacing: "0.08em" }}>
        LEAD PIPELINE
      </div>
      {[
        { stage: "New Inquiry", count: 12, pct: 100, color: "#6aaaff" },
        { stage: "Proposal Sent", count: 8, pct: 67, color: "#b89eff" },
        { stage: "Itinerary Ready", count: 5, pct: 42, color: "#fbbf5a" },
        { stage: "Booking Confirmed", count: 3, pct: 25, color: "#4eeaaa" },
      ].map((p) => (
...
/* ─────────────────────────────────────────
   GrwFit Mockup — compact horizontal
───────────────────────────────────────── */
function GrwFitMockup() {
  return (
    <div style={{ padding: "16px 18px", fontFamily: "monospace" }}>
          ...
          {["Members", "Payments", "Trainers"].map((t) => (
            <span
              ...
              style={{
                ...
                padding: "2px 7px",
                borderRadius: "4px",
                background: t === "Members" ? "rgba(34,214,138,0.2)" : "rgba(255,255,255,0.06)",
                color: t === "Members" ? "#4eeaaa" : "rgba(255,255,255,0.3)",
              }}
            >
              {t}
            </span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "7px", marginBottom: "14px" }}>
        {[
          { label: "Active Members", val: "312", color: "#4eeaaa" },
          { label: "Due Renewals", val: "27", color: "#fbbf5a" },
          { label: "Revenue", val: "₹1.8L", color: "#b89eff" },
        ].map((s) => (
          <div
            key={s.label}
            style={{
          ...
          <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: "3px" }}>
            <div
              style={{
                ...
                background: b.h === 100 ? "#22d68a" : "rgba(34,214,138,0.28)",
              }}
            />
      ...
      {[
        { name: "Vikram T.", days: "12d absent", risk: "High", riskColor: "#ff7a7a" },
        { name: "Sneha R.", days: "5d absent", risk: "Med", riskColor: "#fbbf5a" },
        { name: "Arjun P.", days: "1d absent", risk: "Low", riskColor: "#4eeaaa" },
      ].map((m) => (
        <div
          key={m.name}
          style={{
