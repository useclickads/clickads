      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, pointerEvents: "none", zIndex: 0 }}>
          ...
          <div style={{
            ...
            background: "radial-gradient(ellipse, rgba(167,139,250,0.35) 0%, transparent 68%)",
            filter: "blur(72px)",
          }} />
          <div style={{
        ...
        <div style={{
          ...
          backgroundRepeat: "repeat", backgroundSize: "180px 180px", opacity: 0.7,
        }} />

        {/* Top glowing border line */}
        <div style={{
          position: "absolute", top: 0, left: "10%", right: "10%", height: "1px",
          background: "linear-gradient(to right, transparent, rgba(139,92,246,0.6) 40%, rgba(192,132,252,0.6) 60%, transparent)",
          zIndex: 2,
        }} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "24px" }}>
            <div style={{
              ...
              <span style={{
                ...
                background: "#a78bfa",
                boxShadow: "0 0 8px rgba(167,139,250,0.95)",
          ...
          {/* Headline */}
          <h2 style={{
            fontSize: isMobile ? "32px" : "clamp(32px, 5vw, 58px)",
            fontWeight: 700,
                ...
                <div style={{
                  ...
                  <input
                    ...
                    style={{
                      ...
                      fontFamily: "Inter, sans-serif", fontWeight: 300, minWidth: 0,
                    }}
                  />
                </div>
                <button style={{
                  ...
                  padding: "15px 24px", fontSize: "14px", fontWeight: 600,
            ...
            {stats.map((stat, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "16px",
                  padding: isMobile ? "20px 14px 16px" : "24px 20px 20px",
                  textAlign: "center",
                  position: "relative",
                  overflow: "hidden",
                ...
                onMouseEnter={e => {
                  ...
                  el.style.boxShadow = "0 0 28px rgba(124,58,237,0.22), inset 0 1px 0 rgba(255,255,255,0.09)";
              ...
              >
                ...
                <div style={{ fontSize: isMobile ? "18px" : "22px", marginBottom: "10px", lineHeight: 1 }}>
                  {stat.icon}
                </div>
                <div style={{
                  fontSize: isMobile ? "22px" : "30px",
                  fontWeight: 700, letterSpacing: "-1px",
                  color: "#c4b5fd", marginBottom: "6px", lineHeight: 1,
                }}>
                  {stat.value}
                </div>
                <div style={{
