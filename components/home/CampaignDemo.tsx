...
function ResultCard({ result }: { result: typeof results[0] }) {
  return (
    <div style={{
      ...
      border: "1.5px solid #2a2a2a", padding: "16px",
      ...
      <div style={{
        ...
        fontSize: "11px", fontWeight: 700, color: result.platformColor,
      }}>
        {result.platformIcon}
      </div>
...
export default function CampaignDemo() {
  ...
  return (
    <section style={{
      ...
      padding: isMobile ? "60px 0 72px" : "100px 0 120px",
      ...
      <div style={{ textAlign: "center", marginBottom: isMobile ? "32px" : "60px", padding: "0 24px", position: "relative" }}>
        ...
        <h2 style={{
          color: "#ffffff",
          fontSize: isMobile ? "clamp(24px, 7vw, 34px)" : "clamp(32px, 4vw, 42px)",
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "0 20px", position: "relative" }}>
        ...
        <div style={{ background: "#111", border: "1.5px solid #2a2a2a", borderRadius: "20px", padding: isMobile ? "16px" : "20px 24px", marginBottom: "16px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            ...
            <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.3)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
              Campaign Brief
            </span>
            <span style={{ fontSize: "10px", padding: "3px 8px", borderRadius: "6px", background: "rgba(200,241,53,0.1)", color: "#c8f135", border: "1px solid rgba(200,241,53,0.2)" }}>
              AI Ready
            </span>
          </div>
        ...
        {isMobile ? (
          <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "24px" }}>
            ...
            <button style={{ background: "#fff", color: "#000", fontSize: "13px", fontWeight: 700, padding: "12px", borderRadius: "100px", border: "none", cursor: "pointer", width: "100%" }}>
              Launch Campaign →
            </button>
          </div>
        ) : (
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <div
          ...
          style={{
            ...
            padding: isMobile ? "16px 20px 8px" : "16px 48px 8px",
